...
export default function LandingPage() {
  ...
  return (
    <div style={{ backgroundColor: '#0a0a0f', color: '#f1f5f9', fontFamily: "'Inter', sans-serif", minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      <section style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', padding: '120px 24px 80px' }}>
        ...
        <motion.div style={{ y: heroY, position: 'relative', zIndex: 1, textAlign: 'center', maxWidth: '860px' }}>
          ...
          <motion.h1
            ...
            style={{ fontSize: 'clamp(48px, 7vw, 88px)', fontWeight: 900, lineHeight: 1.05, letterSpacing: '-0.03em', margin: '0 0 28px' }}
          >
          ...
          <motion.p
            ...
            style={{ fontSize: '20px', color: '#64748b', maxWidth: '600px', margin: '0 auto 48px', lineHeight: 1.7 }}
          >
          ...
          <motion.div
            ...
            style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap', marginTop: '64px' }}
          >
            {[
              { icon: '✨', text: 'AI-powered advice' },
              { icon: '⚡', text: 'Real-time sync' },
              { icon: '🔒', text: 'Supabase RLS secured' },
      ...
      {/* ── FOOTER ── */}
      <footer style={{ borderTop: '1px solid rgba(255,255,255,0.06)', padding: '32px 48px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', color: '#475569', fontSize: '14px' }}>
        ...
        <div>Built with Next.js, Supabase & Gemini AI</div>
      </footer>
    </div>
  );
}
